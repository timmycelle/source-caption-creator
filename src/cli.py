...
parser.add_argument("-game", type=str, required=True, help="Source Engine game directory | e.g. \"Portal 2\\portal2\"")
...
parser.add_argument("--compile-captions", "--comp-c", action="store_true", help="Compile converted captions to closecaption_<lang>.dat")
